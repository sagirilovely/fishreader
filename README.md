...
<p align="center">
  <b>🌐 网页摸鱼模式：1:1 高仿真官方技术文档 + 赞助位视频播放</b><br>
  <img src="demo2.png" alt="fishreader 网页文档摸鱼模式演示效果" width="85%">
</p>

<p align="center">
  <b>🛡️ 网页老板模式：瞬间切为真实官方技术文档 + 霓虹流光垃圾广告战术掩护</b><br>
  <img src="demo3.png" alt="fishreader 网页老板模式演示效果" width="85%">
</p>

为程序员量身定制的摸鱼小说阅读器。支持**终端 TUI** 与 **浏览器 Web** 双重高拟真伪装：
- **终端模式**：主体持续滚动英文代码 Agent / Vite / npm / Git 日志，小说只占一小块区域伪装成工作笔记。
- **网页摸鱼模式**：1:1 像素级复刻主流官方技术文档（Vue 3 / React / Rust / Python），小说智能排版载入文档正文、提示框与代码块，右下角赞助位支持摸鱼看视频。
- **网页老板模式**：一键脱险，正文瞬间切为 100% 真实官方技术文档，视频自动暂停并覆上引人注目的流光垃圾广告，实现视线转移反侦察。
- **双向互通**：终端与网页端阅读进度实时自动同步，无缝切换。
...
| `←` / `PgUp` | 上一页 |
| `↓` | 向下滚动一行 |
| `b` / `↑` | **终端老板键**：切换全屏英文工作日志（翻页手在方向键区，按 `↑` 瞬间脱险） |
| `n` / `p` | 下一章 / 上一章 |
